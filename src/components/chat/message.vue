<template>
	<!-- 	<div>
		<div class="cardHeigh">
			<span style="align-items: center; size: 35px;font-family: STKaiti;">
    ...
    <div id="message" v-scroll-bottom="sessions">
        <ul v-if="currentSession">
			...
			<li class="mainx">
			    ...
			    <div>
			        <img class="avatar" :src="user.userface" alt="">
			        ...
			        <p class="text">saaaaaaaaa打开了方式收定金付了时代峻峰aaaaaaaaaaaddddddddddddddds</p>
			    </div>
			</li>
			    ...
			    <div class="self" >
			        <img class="avatar" :src="currentSession.userface" alt="">
			        <!-- <p class="text">张三</p> -->
			    </div>
			</li>
        </ul>
